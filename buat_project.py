...
android {
    compileSdk 33
    defaultConfig {
        applicationId "com.sulzxbug.app"
        minSdk 21
        targetSdk 33
        versionCode 1
        versionName "1.0"
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:label="SulzXbug"
        android:theme="@style/Theme.SulzXbug"
...
""".strip(),
    ...
    "app/src/main/java/com/sulzxbug/app/MainActivity.java": """
package com.sulzxbug.app;
...
<androidx.constraintlayout.widget.ConstraintLayout
    ...
    <TextView
        android:id="@+id/labelBugNomor"
        android:layout_width="wrap_content"
        android:layout_height="wrap_content"
        android:text="BUG NOMOR"
        android:textColor="@color/cyan_neon"
        android:textSize="14sp"
        android:textStyle="bold"
        app:layout_constraintStart_toStartOf="parent"
    ...
    <EditText
        ...
        app:layout_constraintStart_toStartOf="parent"
        app:layout_constraintTop_toBottomOf="@+id/labelBugNomor"/>

    <TextView
        android:id="@+id/labelBugGroup"
        android:layout_width="wrap_content"
        android:layout_height="wrap_content"
        android:text="BUG GROUP"
        android:textColor="@color/cyan_neon"
        android:textSize="14sp"
        android:textStyle="bold"
        app:layout_constraintStart_toStartOf="parent"
        app:layout_constraintTop_toBottomOf="@+id/etBugNomor"
        android:layout_marginTop="16dp"/>

    <EditText
        android:id="@+id/etBugGroup"
        android:layout_width="0dp"
        android:layout_height="48dp"
        android:layout_marginTop="8dp"
        android:background="@drawable/input_bg"
        android:hint="Group ID / Link"
        android:paddingStart="16dp"
        android:textColor="@color/white"
        android:textColorHint="@color/gray_light"
        app:layout_constraintEnd_toEndOf="parent"
        app:layout_constraintStart_toStartOf="parent"
        app:layout_constraintTop_toBottomOf="@+id/labelBugGroup"/>
    ...
    <androidx.gridlayout.GridLayout
        ...
        app:layout_constraintEnd_toEndOf="parent"
        app:layout_constraintStart_toStartOf="parent"
        app:layout_constraintTop_toBottomOf="@+id/etBugGroup">
...
<resources>
    <color name="background_dark">#0B0E14</color>
    <color name="cyan_neon">#00F5FF</color>
    <color name="white">#FFFFFF</color>
    <color name="gray_light">#8A9BB5</color>
    <color name="button_bg">#1A2530</color>
    <color name="button_text">#B0C7E7</color>
</resources>
""".strip(),

    "app/src/main/res/values/themes.xml": """
<resources>
    <style name="Theme.SulzXbug" parent="Theme.MaterialComponents.DayNight.NoActionBar">
        <item name="android:statusBarColor">@color/background_dark</item>
        <item name="android:navigationBarColor">@color/background_dark</item>
    </style>

    <style name="MenuButton" parent="Widget.MaterialComponents.Button.UnelevatedButton">
...
<shape xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <solid android:color="#1A2530" />
    <corners android:radius="12dp" />
    <stroke android:width="1dp" android:color="#2A4A5A" />
</shape>
""".strip(),
...
with open("gradlew", "w") as f:
    f.write("#!/bin/sh\necho 'Gradle wrapper not needed'\n")
...
print("  git init")
print("  git add .")
print("  git commit -m 'SulzXbug source'")
print("  git remote add origin https://github.com/USERNAME/SulzXbug.git")
print("  git push -u origin main")
print("🔁 Lalu buka GitHub Actions, tunggu build selesai, download APK.")
